...
CREATE TABLE IF NOT EXISTS "accum_register__nomenclature_stock" (
    "id" BIGSERIAL NOT NULL PRIMARY KEY,
    "registrator" VARCHAR(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS "dir__recipe_cards__values" (
    "id" VARCHAR(15) NOT NULL  PRIMARY KEY,
    "ordering" SMALLINT NOT NULL,
    "count" DOUBLE PRECISION NOT NULL,
    "owner_id" INT NOT NULL REFERENCES "dir__recipe_cards" ("id") ON DELETE CASCADE,
    "product_id" BIGINT NOT NULL REFERENCES "dir__nomenclature" ("id") ON DELETE RESTRICT
);
COMMENT ON TABLE "dir__recipe_cards__values" IS 'Ингредиенты';
CREATE TABLE IF NOT EXISTS "dir__users" (
    ...
    "can_login_admin" BOOL NOT NULL  DEFAULT False,
...
CREATE TABLE IF NOT EXISTS "doc__nomenclature_write_offs" (
    ...
    "responsible_id" INT NOT NULL REFERENCES "dir__employees" ("id") ON DELETE RESTRICT
);
...
CREATE TABLE IF NOT EXISTS "doc__nomenclature_write_offs__values" (
    ...
    "owner_id" BIGINT NOT NULL REFERENCES "doc__nomenclature_write_offs" ("id") ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "doc__price_setups" (
    "id" BIGSERIAL NOT NULL PRIMARY KEY,
    "conducted" BOOL NOT NULL  DEFAULT False,
    "dt" TIMESTAMPTZ NOT NULL  DEFAULT CURRENT_TIMESTAMP,
    "comment" TEXT NOT NULL,
...
COMMENT ON TABLE "doc__price_setups" IS 'Документ установки цен (УЦ)';
CREATE TABLE IF NOT EXISTS "doc__price_setups__values" (
    "id" VARCHAR(15) NOT NULL  PRIMARY KEY,
    "ordering" SMALLINT NOT NULL,
    "price" DOUBLE PRECISION NOT NULL,
    "nomenclature_id" BIGINT NOT NULL REFERENCES "dir__nomenclature" ("id") ON DELETE RESTRICT,
    "owner_id" BIGINT NOT NULL REFERENCES "doc__price_setups" ("id") ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "doc__product_assemblies__values" (
    ...
    "count" DOUBLE PRECISION NOT NULL,
    "nomenclature_id" BIGINT NOT NULL REFERENCES "dir__nomenclature" ("id") ON DELETE RESTRICT,
    "owner_id" BIGINT NOT NULL REFERENCES "doc__product_assemblies" ("id") ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "doc__provider_returns__values" (
    ...
    "price" DOUBLE PRECISION NOT NULL,
    "nomenclature_id" BIGINT NOT NULL REFERENCES "dir__nomenclature" ("id") ON DELETE RESTRICT,
    "owner_id" BIGINT NOT NULL REFERENCES "doc__provider_returns" ("id") ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "doc__receives__values" (
    ...
    "price" DOUBLE PRECISION NOT NULL,
    "nomenclature_id" BIGINT NOT NULL REFERENCES "dir__nomenclature" ("id") ON DELETE RESTRICT,
    "owner_id" BIGINT NOT NULL REFERENCES "doc__receives" ("id") ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "doc__customer_returns__values" (
    ...
    "price" DOUBLE PRECISION NOT NULL,
    "nomenclature_id" BIGINT NOT NULL REFERENCES "dir__nomenclature" ("id") ON DELETE RESTRICT,
    "owner_id" BIGINT NOT NULL REFERENCES "doc__customer_returns" ("id") ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "doc__sales__values" (
    ...
    "price" DOUBLE PRECISION NOT NULL,
    "nomenclature_id" BIGINT NOT NULL REFERENCES "dir__nomenclature" ("id") ON DELETE RESTRICT,
    "owner_id" BIGINT NOT NULL REFERENCES "doc__sales" ("id") ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "doc__stocktakes__values" (
    ...
    "count" DOUBLE PRECISION NOT NULL,
    "nomenclature_id" BIGINT NOT NULL REFERENCES "dir__nomenclature" ("id") ON DELETE RESTRICT,
    "owner_id" BIGINT NOT NULL REFERENCES "doc__stocktakes" ("id") ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "info_register__nomenclature_costs__result" (
    "id" VARCHAR(25) NOT NULL  PRIMARY KEY,
    "dt" TIMESTAMPTZ NOT NULL  DEFAULT CURRENT_TIMESTAMP,
    "cost" DOUBLE PRECISION NOT NULL,
    "nomenclature_id" BIGINT NOT NULL UNIQUE REFERENCES "dir__nomenclature" ("id") ON DELETE CASCADE
);
CREATE TABLE IF NOT EXISTS "info_register__nomenclature_prices" (
    "id" BIGSERIAL NOT NULL PRIMARY KEY,
    "registrator" VARCHAR(20) NOT NULL,
    "dt" TIMESTAMPTZ NOT NULL,
    "price" DOUBLE PRECISION NOT NULL,
...
CREATE TABLE IF NOT EXISTS "info_register__nomenclature_prices__result" (
    "id" VARCHAR(25) NOT NULL  PRIMARY KEY,
    "dt" TIMESTAMPTZ NOT NULL  DEFAULT CURRENT_TIMESTAMP,
    "price" DOUBLE PRECISION NOT NULL,
    "nomenclature_id" BIGINT NOT NULL REFERENCES "dir__nomenclature" ("id") ON DELETE RESTRICT,
    "price_group_id" INT NOT NULL REFERENCES "dir__price_groups" ("id") ON DELETE CASCADE,
    CONSTRAINT "uid_info_regist_nomencl_1330a3" UNIQUE ("nomenclature_id", "price_group_id")
);"""
