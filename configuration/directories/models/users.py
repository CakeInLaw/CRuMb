...
if TYPE_CHECKING:
    from configuration.directories.models import Employee, CustomerLocations
...
class User(Directory):
    ...
    customer_location: Union["CustomerLocations", fields.BackwardOneToOneRelation["CustomerLocations"]]
