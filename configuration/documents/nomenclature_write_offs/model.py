...
__all__ = ["NomenclatureWriteOff", "NomenclatureWriteOffValuesList"]
...
class NomenclatureWriteOffValuesList(MoveDocumentValuesList):
    price: float = orm_fields.FloatField(min_value=0)
    owner: Union["NomenclatureWriteOff", fields.ForeignKeyRelation["NomenclatureWriteOff"]] = fields.ForeignKeyField(
